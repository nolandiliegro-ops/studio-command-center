...
const HeroSection = () => {
  ...
  return (
    <section className="min-h-screen pt-20 lg:pt-24 pb-12 lg:pb-0 flex items-center">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-center min-h-[calc(100vh-6rem)]">
          ...
          <div className="order-1 lg:order-2 min-h-[400px] lg:min-h-[500px]">
            <ScooterCarousel
