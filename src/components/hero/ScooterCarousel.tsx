  ...
  return (
    <div className="relative flex items-center justify-center h-full w-full">
      ...
      <div className="relative flex items-center justify-center w-full h-full">
        ...
        {/* Info Panel - Positioned to the Right */}
        {activeModel && (
          <motion.div 
            key={activeModel.id}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-[10%] lg:translate-x-[5%] text-left z-20 hidden lg:block"
          ...
          >
            {/* Brand Badge - Subtle */}
            <motion.div
              className="inline-block px-3 py-1 rounded-full bg-white/80 border border-mineral/20 backdrop-blur-sm mb-3"
            ...
            {/* Model Name - Elegant */}
            <motion.h3 
              className="font-display text-3xl lg:text-4xl text-carbon mb-3 tracking-wide leading-tight"
            ...
            <motion.div
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/70 border border-mineral/15 backdrop-blur-sm"
      ...
      {/* Mobile Info Panel - Below carousel */}
      {activeModel && (
        <motion.div 
          key={`mobile-${activeModel.id}`}
        ...
        >
          ...
          <motion.div
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/60 border border-mineral/15 backdrop-blur-sm mb-4"
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ delay: 0.35 }}
          >
